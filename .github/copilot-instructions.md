# yohan-control-tower — GitHub Copilot Instructions
...
- 포트: **3001**
- **brain = SoT.** 관제탑은 읽기 자유 + **신규 파일 생성만** 허용. 기존 brain 파일 수정은 금지 (계약 `must_not: modify_existing_brain_files`).
...
## 코딩 규칙
- TypeScript strict — `any` 금지. 공용 타입은 `lib/types.ts` 가 SoT.
