...
export const SOURCES: SourceConfig[] = [
  // ── Tier 1 ──
  { slug: 'ai-dictionary', source: 'ai_dictionary', collection: 'knowledge_base', tier: 1, label: 'AI 사전', kind: 'database', notionId: '3349740ab07280479b76cbe59b50c863', envVar: 'NOTION_AI_DICTIONARY_DB_ID', expected: 80 },
  { slug: 'protocol', source: 'protocol', collection: 'system_rules', tier: 1, label: 'PROTOCOL', kind: 'database', notionId: '7668be4ce9464933a36388aa285b50b3', envVar: 'NOTION_PROTOCOL_DB_ID', expected: 20 },
  { slug: 'rulebook', source: 'rulebook', collection: 'system_rules', tier: 1, label: 'RULEBOOK', kind: 'database', notionId: 'befb40e13612403fbfb474804948101b', envVar: 'NOTION_RULEBOOK_DB_ID', expected: 25 },

  // ── Tier 2 ──
  { slug: 'summary', source: 'summary', collection: 'knowledge_base', tier: 2, label: 'SUMMARY', kind: 'database', notionId: '5b1d339873c54df19e5da1e69602b902', envVar: 'NOTION_SUMMARY_DB_ID', expected: 25 },
  { slug: 'knowledge-hub', source: 'knowledge_hub', collection: 'knowledge_base', tier: 2, label: '지식 허브', kind: 'database', notionId: '69a8df149c0d4e068f9dceb9d52a9975', envVar: 'NOTION_KNOWLEDGE_HUB_DB_ID', expected: 10 },
  { slug: 'person', source: 'person_db', collection: 'knowledge_base', tier: 2, label: '인물 DB', kind: 'database', notionId: '9c753cddbd3446aa9b48e4b6a746fc9d', envVar: 'NOTION_PERSON_DB_ID', expected: 115 },
  { slug: 'keyword', source: 'keyword_db', collection: 'knowledge_base', tier: 2, label: '키워드 DB', kind: 'database', notionId: '68ccd74d11dc4704b54bd169e026246d', envVar: 'NOTION_KEYWORD_DB_ID', expected: 30 },
  ...
  { slug: 'preference', source: 'preference_db', collection: 'system_rules', tier: 2, label: '취향 DB', kind: 'database', notionId: '2f22671372d24da1b1f7746b6609f621', envVar: 'NOTION_PREFERENCE_DB_ID', expected: 80 },
