 ...
 */
export function configuredPreviewHostname(env: NodeJS.ProcessEnv = process.env): string | null {
 ...
 */
export function originMatchesExpected(originHeader: string, expectedUrl: URL, env: NodeJS.ProcessEnv = process.env): boolean {
  try {
