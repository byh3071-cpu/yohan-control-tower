...
import type { StatusResponse, IngestSummary, QueryResponse, CollectionName } from '@/lib/types'
import { sourcesByTier } from '@/lib/sources'
...
export default function Dashboard() {
  ...
  const runIngest = useCallback(
    async (slug: string, label: string) => {
      ...
      try {
        const res = await fetch(`/api/ingest/${slug}`, { method: 'POST' })
